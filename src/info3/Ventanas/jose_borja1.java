 ...
 */
public class jose_borja1 extends javax.swing.JFrame {

    /**
     * Creates new form jose_borja1
     */
    public jose_borja1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jose_borja1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jose_borja1().setVisible(true);
            }
        });
    }
